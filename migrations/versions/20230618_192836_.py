...
Revision ID: e45d53838346
Revises: 
Create Date: 2023-06-18 19:28:36.294029
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('travelclass_id', sa.Integer(), nullable=True),
    ...
    sa.Column('created_at', sa.String(length=100), nullable=False),
    sa.ForeignKeyConstraint(['travelclass_id'], ['travel_classes.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
